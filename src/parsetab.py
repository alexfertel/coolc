...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','arithmetic.py',59),
  ('statement -> expression','statement',1,'p_statement_expr','arithmetic.py',64),
  ('expression -> expression + expression','expression',3,'p_expression_binop','arithmetic.py',69),
  ('expression -> expression - expression','expression',3,'p_expression_binop','arithmetic.py',70),
  ('expression -> expression * expression','expression',3,'p_expression_binop','arithmetic.py',71),
  ('expression -> expression / expression','expression',3,'p_expression_binop','arithmetic.py',72),
  ('expression -> - expression','expression',2,'p_expression_uminus','arithmetic.py',84),
  ('expression -> ( expression )','expression',3,'p_expression_group','arithmetic.py',89),
  ('expression -> NUMBER','expression',1,'p_expression_number','arithmetic.py',94),
  ('expression -> NAME','expression',1,'p_expression_name','arithmetic.py',99),
]
